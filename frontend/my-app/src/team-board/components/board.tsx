  ...
  const {
    ...
    return(
        <div className='teams-background'>
            ...
            {showAdminSettings && <AdminSettings AdminSettingsRef={AdminSettingsRef} setAdminSettings={setAdminSettings} GroupMembers={GroupMembers} currentGroup={currentGroup} NotGroupMember={NotGroupMember} handleToggleAdmin={handleToggleAdmin} kickMember={kickMember} enviteMember={enviteMember}/>}
